...
public class XuLy {
	...
	public XuLy() {
		...
		System.out.print("Vui lòng nhập vào bán kính của đường tròn: ");
		banKinh = Integer.parseInt(scan.nextLine());
		
		System.out.print("Vui lòng nhập vào tọa độ x của tâm đường tròn: ");
		xC = Float.parseFloat(scan.nextLine());
		
		System.out.print("Vui lòng nhập vào tọa độ y của tâm đường tròn: ");
		yC = Float.parseFloat(scan.nextLine());
		
		System.out.print("Vui lòng nhập vào tọa độ x của điểm M: ");
		xM = Float.parseFloat(scan.nextLine());
		
		System.out.print("Vui lòng nhập vào tọa độ y của điểm M: ");
